...
const OsseousSurgery = () => {
  ...
  const schemaData = {
    ...
    description:
      'Professional osseous surgery (pocket reduction surgery) in Atlanta, GA. Expert surgical treatment for advanced gum disease and bone loss.',
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
          <div className="section-animate">
            ...
            <p className="mt-4 font-serif text-lg leading-relaxed text-primary/70">
              Osseous surgery, also known as pocket reduction surgery or flap surgery, is a surgical procedure used to
              treat advanced gum disease (periodontitis). When gum disease causes deep pockets to form around your teeth
              and leads to bone loss, osseous surgery reshapes the underlying bone and removes diseased tissue to
              eliminate these pockets and make it easier to maintain oral hygiene.
            </p>
            <p className="mt-4 font-serif text-lg leading-relaxed text-primary/70">
              This procedure is typically recommended when non‑surgical treatments like scaling and root planing have not
              been sufficient to control the infection. By accessing the roots and supporting bone, we can thoroughly
              clean the area, reshape irregular bone contours, and secure the gums back into place to promote healing and
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center section-animate">
            ...
            <p className="max-w-2xl mx-auto mt-4 font-serif text-lg text-primary/70">
              This surgical intervention is typically recommended when other treatments have failed to address advanced
          ...
          <div className="mt-12 text-center section-animate">
            <p className="font-serif text-lg text-primary/70">
              <strong>Don't wait until it's too late.</strong> Early surgical intervention can save teeth and prevent the
              need for extraction.
            </p>
            <button
              onClick={() => window.open('https://book.modento.io/atlanta-periodontal-group', '_blank')}
      ...
      <section className="max-w-6xl px-6 py-16 mx-auto md:py-24 md:px-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
          ...
          <div className="order-1 section-animate md:order-2">
            ...
            <p className="mt-4 font-serif text-lg leading-relaxed text-primary/70">
              Osseous surgery is performed under local anesthesia, and in some cases, sedation options are available to
              ensure your comfort. The procedure typically takes 1–2 hours, depending on the extent of the disease.
            </p>
      ...
      <section className="max-w-6xl px-6 py-16 mx-auto md:py-24 md:px-16">
        <div className="bg-primary/5 rounded-[3rem] overflow-hidden relative p-12 md:p-24 flex flex-col items-center text-center shadow-[inset_0_0_100px_rgba(0,0,0,0.02)] border border-primary/10">
          ...
          <p className="relative z-10 max-w-2xl mt-6 font-sans text-lg text-primary/80">
            Schedule your osseous surgery consultation with Atlanta's most trusted periodontists. Let us help you preserve
            your teeth and restore your oral health with expert surgical care.
          </p>
